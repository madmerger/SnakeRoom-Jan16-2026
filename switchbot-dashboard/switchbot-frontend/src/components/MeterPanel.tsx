      ...
      <div className="p-4">
        <div className="flex flex-wrap gap-2 mb-4">
          {meter.current_temperature !== null && (
            <div className="stat-card rounded-lg px-3 py-2 flex items-center gap-2">
              <div className="w-6 h-6 rounded bg-gradient-to-br from-rose-500/20 to-orange-500/20 flex items-center justify-center">
                <svg className="w-3.5 h-3.5 text-rose-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                </svg>
              </div>
              <span className="text-base font-semibold text-white">{meter.current_temperature}°C</span>
            </div>
          )}
          {meter.current_humidity !== null && (
            <div className="stat-card rounded-lg px-3 py-2 flex items-center gap-2">
              ...
              <span className="text-base font-semibold text-white">{meter.current_humidity}%</span>
            </div>
          )}
          {meter.battery !== null && (
            <div className="stat-card rounded-lg px-3 py-2 flex items-center gap-2">
              ...
              <span className="text-base font-semibold text-white">{meter.battery}%</span>
            </div>
          )}
        </div>
